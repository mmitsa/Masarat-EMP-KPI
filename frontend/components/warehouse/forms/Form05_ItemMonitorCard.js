/**
 * نموذج رقم (5) - بطاقة مراقبة الصنف
 * Item Monitoring Card - for inventory control department
...
export default function Form05_ItemMonitorCard({ data = {} }) {
  const {
    documentNumber,
    date,
    hijriDate,
  ...
  return (
    ...
    >
      ...
      <div className="gov-form-card-header">
        ...
        <div className="gov-form-card-field">
          <span className="gov-form-card-label">قسم مراقبة المخزون:</span>
