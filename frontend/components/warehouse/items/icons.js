...
export function DurableIcon({ className = "w-5 h-5" }) {
...
export function ConsumableIcon({ className = "w-5 h-5" }) {
...
export function HandIcon({ className = "w-5 h-5" }) {
...
// أيقونات جديدة للتابات

export function RulerIcon({ className = "w-5 h-5" }) {
    return <svg className={className} fill="none" stroke="currentColor" viewBox="0 0 24 24"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M19 21l-7-5-7 5V5a2 2 0 012-2h10a2 2 0 012 2z" /></svg>;
}

export function ConvertIcon({ className = "w-5 h-5" }) {
...
export function SerialIcon({ className = "w-5 h-5" }) {
    return <svg className={className} fill="none" stroke="currentColor" viewBox="0 0 24 24"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M7 20l4-16m2 16l4-16M6 9h14M4 15h14" /></svg>;
}

export function BalanceIcon({ className = "w-5 h-5" }) {
